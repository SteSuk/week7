...
const heroes = ["Harry Potter", "Luke Skywalker", "Batman", "Cyborg", "Aquaman"];
const villains = ["Lord Voldemort", "Darth Vader", "Joker", "Loki", "Sauron"];
const weapon = ["plastic knife", "flip-flop", "magic stick", "raw egg", "borken sword", "paper"];
